...
const Parameters: React.FC = () => {
  ...
  // Add new state for sources management
  const [cashInSources, setCashInSources] = useState([
    { id: 1, name: 'Client Payment', active: true },
    { id: 2, name: 'Investment', active: true },
    { id: 3, name: 'Loan', active: true },
  ]);
  
  const [cashOutSources, setCashOutSources] = useState([
          ...
          <Grid container spacing={3} sx={{ p: 2 }}>
            ...
            <Grid item xs={12} md={6}>
              <Paper sx={{ p: 3, borderRadius: 2, boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
                <Typography variant="h6" gutterBottom sx={{ color: '#388e3c', display: 'flex', alignItems: 'center' }}>
                  <TrendingUp sx={{ mr: 1 }} />
                  {t('cashInSources')}
                </Typography>
                <Divider sx={{ mb: 2 }} />
                ...
                {editingSource && editingSource.type === 'in' ? (
                  ...
                  <Box sx={{ display: 'flex', mt: 2 }}>
                    ...
                    <Button 
                      ...
                      sx={{ ml: 1, bgcolor: '#388e3c', '&:hover': { bgcolor: '#2e7d32' } }}
                    >
                      {t('add')}
                    </Button>
                  </Box>
                ...
                {editingSource && editingSource.type === 'out' ? (
                  ...
                  <Box sx={{ display: 'flex', mt: 2 }}>
                    ...
                    <Button 
                      ...
                      sx={{ ml: 1, bgcolor: '#d32f2f', '&:hover': { bgcolor: '#c62828' } }}
                    >
                      {t('add')}
                    </Button>
                  </Box>
